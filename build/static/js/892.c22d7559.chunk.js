"use strict";(self.webpackChunkkenshin13=self.webpackChunkkenshin13||[]).push([[892],{7892:(e,t,i)=>{i.r(t),i.d(t,{default:()=>E});var r=i(5043),a=i(5464),o=i(8270),n=i(4404),s=i(6759),c=i(6938),l=i(579);o.Ay.registerPlugin(n.u);const d=a.Ay.section`
...
`,A=a.Ay.div`
  ...
  &::before {
    ...
    right: 0;
    bottom: 0;
    background: ${e=>`radial-gradient(circle at 30% 50%, ${e.$accent}15 0%, transparent 60%)`};
...
`,R=(0,a.Ay)(s.P.div)`
  ...
  svg {
    filter: drop-shadow(0 0 40px ${e=>e.$accent}40);
    transition: all 0.15s ease;
    
    &:hover {
      transform: scale(1.05) rotate(5deg);
      filter: drop-shadow(0 0 60px ${e=>e.$accent}60);
    }
  }
`,P=a.Ay.div`
  position: fixed;
